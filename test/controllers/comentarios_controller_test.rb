...
class ComentariosControllerTest < ActionController::TestCase
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post :create, comentario: { data_hora: @comentario.data_hora, registro_id: @comentario.registro_id, texto_comentario: @comentario.texto_comentario, usuario_projeto_id: @comentario.usuario_projeto_id }
    end
  ...
  test "should update comentario" do
    patch :update, id: @comentario, comentario: { data_hora: @comentario.data_hora, registro_id: @comentario.registro_id, texto_comentario: @comentario.texto_comentario, usuario_projeto_id: @comentario.usuario_projeto_id }
    assert_redirected_to comentario_path(assigns(:comentario))
  end
